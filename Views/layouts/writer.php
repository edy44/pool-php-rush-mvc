...
<html lang="fr">
    <head>
        ...
        <title><?= $title_for_layout; ?> - Auteur</title>
        <link href="<?= $this->form->webroot('Webroot/css/materialize.min.css'); ?>" rel="stylesheet">
        <link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
        <link href="<?= $this->form->webroot('Webroot/css/writer.css'); ?>" rel="stylesheet">
        ...
        <div class="navbar-fixed">
            <nav>
                <div class="nav-wrapper">
                    <a href="<?= $this->form->url('admin/articles/index'); ?>" class="brand-logo">Auteur</a>
