 ...
 */
class ArticlesController extends AppWriterController
{
    ...
    public function index()
    {
        ...
        $articles = $this->articles->find_all_with_category_and_user(['user_id' => $id], ['modification_date' => 'DESC']);
    ...
    public function edit(int $id)
    {
        ...
        $this->vars = compact('id','title', 'description', 'category_id', 'categories', 'tags');
    }

    /**
     * Supprimer définitivement un article avec ses commentaires et tags associés
     * @param int $id
     */
